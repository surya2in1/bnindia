     ...
     <div class="kt-header__topbar">
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<!--begin: Head -->
									<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(<?= Router::url('/', true); ?>assets/media/misc/bg-1.jpg)">
									...
									<div class="kt-notification">
										<a href="<?= Router::url('/', true);?>personalinfo" class="kt-notification__item">
										...
										<div class="kt-notification__custom kt-space-between">
											<a href="<?= Router::url('/', true);?>users/logout" class="btn btn-label btn-label-brand btn-sm btn-bold">Sign Out</a>
										</div>
									</div>
