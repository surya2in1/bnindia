...
class MembersGroupsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => 'user_id', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            ...
            'member_group_unique' => ['type' => 'unique', 'columns' => ['user_id', 'group_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'user_id' => 1,
                'group_id' => 1,
                'created_date' => '2020-08-16 20:17:21',
                'modified_date' => '2020-08-16 20:17:21',
            ],
        ];
        parent::init();
    }
