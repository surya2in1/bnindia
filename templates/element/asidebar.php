                        ...
                        <ul class="kt-menu__nav ">
                            <li class="kt-menu__item  <?php if($this->request->getParam('controller') == 'Dashboard') { ?> kt-menu__item--active<?php } ?>" aria-haspopup="true">
                                ...
                                <?php if($list_of_all_users_side_menu == '1111'){?>
                                    <li class="kt-menu__item  <?php if($this->request->getParam('controller') == 'AllUsers') { ?> kt-menu__item--active<?php } ?>" aria-haspopup="true">
                                <a href="<?php echo Router::url('/AllUsers', true); ?>" class="kt-menu__link ">
                                    <span class="kt-menu__link-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <polygon points="0 0 24 0 24 24 0 24"/>
                                    ...
                                    </svg></span><span class="kt-menu__link-text">All Users</span></a></li>
                                <?php } ?>
