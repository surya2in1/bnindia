...
class PermissionsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->scalar('permission')
            ->maxLength('permission', 50)
            ->requirePresence('permission', 'create')
            ->notEmptyString('permission')
            ->add('permission', 'unique', ['rule' => 'validateUnique', 'provider' => 'table']);

        $validator
            ->scalar('permission_desc')
            ->maxLength('permission_desc', 50)
            ->requirePresence('permission_desc', 'create')
            ->notEmptyString('permission_desc');
    ...
    {
        $rules->add($rules->isUnique(['permission']));
