                            ...
                            <div class="kt-widget17__items">
                                <div class="kt-widget17__item">
                                    ...
                                    <span class="kt-widget17__desc">
                                        <?= isset($total_cash[0]['total_notes']) && ($total_cash[0]['total_notes'] > 0) ? $total_cash[0]['total_notes'] : 0;?> 
                                    </span>
                                </div>
                                <div class="kt-widget17__item">
                                    <span class="kt-widget17__icon">
                                    ...
                                    <span class="kt-widget17__desc">
                                        <?= isset($total_cheque_amount[0]['no_of_cheques']) && ($total_cheque_amount[0]['no_of_cheques'] > 0) ? $total_cheque_amount[0]['no_of_cheques'] : 0;?>
                                    </span>
                                </div>
                            </div>
                            <div class="kt-widget17__items">
                                <div class="kt-widget17__item">
                                    ...
                                    <span class="kt-widget17__desc">
                                        <?= isset($total_dd_amount[0]['no_of_dd']) && ($total_dd_amount[0]['no_of_dd'] > 0) ? $total_dd_amount[0]['no_of_dd'] : 0;?>
                                    </span>
                                </div>
                                <div class="kt-widget17__item">
                                    <span class="kt-widget17__icon">
