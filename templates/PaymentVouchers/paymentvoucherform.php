                            ...
                            <div class="kt-section__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="hidden" id="payment_group_id" value="<?= $payment_group_id;?>" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="hidden" name="payment_auction_id" id="payment_auction_id" value="<?= $payment_auction_id;?>" />
                                        <!-- Get groups after select member -->
                                        <select id="auction_id" name="auction_id" class="form-control  border-black">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" class="form-control" name="auction_winner" id="auction_winner" placeholder="Enter User" value="<?=  $payment->auction_winner; ?>" readonly> 
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="number" min="1" class="form-control border-black" name="cheque_dd_no" id="cheque_dd_no" placeholder="Enter Cheque No./ D.D" value="<?= isset($payment->cheque_dd_no) ? $payment->cheque_dd_no : '';?>">
                                    </div>
                                </div>
