...
<div class="kt-subheader  kt-grid__item" id="kt_subheader">
    <div class="kt-container  kt-container--fluid ">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Payment</h3>
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="payment-voucher-form" class="btn btn-brand btn-elevate btn-icon-sm">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="payment_table">
                <thead>
                    <tr>
                        <th>Date</th>
                        <th>Member Name</th>
                        <th>Particular Resaon</th>
                        <th>Group Code</th>
                        <th>Auction No.</th> 
                        <th>Amount Paid</th> 
                        <th>GST</th>
                        <th>Total Dividend Paid</th>
                        <th>Cheque/DD No.</th>
                        <th>Action</th>
                    </tr>
                </thead>
