...
class AssistentHeadsController extends AppController
{
     ...
     * */
    function assistentheadform($id=null){ 
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            $role = $RolesTable->find('all')->where(['name'=>Configure::read('ROLE_ASSISTANT_HEAD')])->first();
    ...
    public function index()
    {
        ...
        if ($this->request->is('post')) {
             $output = $this->Users->GetRoleWiseData($this->Auth->user('id'),Configure::read('ROLE_ASSISTANT_HEAD')); 
